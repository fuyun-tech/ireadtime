...
export class WallpaperModalComponent implements OnChanges {
  ...
  gotoDetail() {
    ...
    window.open(`${environment.wallpaperHost}/detail/${this.activeWallpaper.wallpaperId}?ref=rt_modal${lang}`);
  }
  ...
  gotoWallpaper() {
    window.open(`${environment.wallpaperHost}/detail?ref=rt_modal`);
  }
