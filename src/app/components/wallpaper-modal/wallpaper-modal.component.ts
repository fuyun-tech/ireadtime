...
export class WallpaperModalComponent implements OnChanges {
  ...
  gotoDetail() {
    ...
    window.open(`${environment.wallpaperHost}/wallpaper/${this.activeWallpaper.wallpaperId}?ref=rt_modal${lang}`);
  }
  ...
  gotoWallpaper() {
    window.open(`${environment.wallpaperHost}/wallpaper?ref=rt_modal`);
  }
